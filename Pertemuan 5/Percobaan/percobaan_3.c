...
int main(int argc, char *argv[]) {
    ...
    do {
        system("cls");
        printf("+----+---------------------------------------+");
        printf("\n| NO | SINGLE LINKED LIST                    |");
        printf("\n+----+---------------------------------------+");
        printf("\n| 1  | Buat Single Linked List               |");
        printf("\n| 2  | Tampilkan semua node                  |");
        printf("\n| 3  | Tambah node di awal                   |");
        printf("\n| 4  | Tambah node di akhir                  |");
        printf("\n| 5  | Tambah node sebelum node              |");
        printf("\n| 6  | Tambah node setelah node              |");
        printf("\n| 7  | Hapus node di awal                    |");
        printf("\n| 8  | Hapus node di akhir                   |");
        printf("\n| 9  | Hapus sebuah node tertentu            |");
        printf("\n| 10 | Hapus node setelah node               |");
        printf("\n| 11 | Hapus semua node                      |");
        printf("\n| 12 | Urutkan data                          |");
        printf("\n+----+---------------------------------------+");
        printf("\n| 13 | KELUAR PROGRAM                        |");
